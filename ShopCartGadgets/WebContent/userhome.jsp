...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
	  ...
	  <li><a href="usereditregister.jsp"><span class="glyphicon glyphicon-log-in"style="padding-right: 4px";>
	  </span>Edit Details</a></li>
	  
	<li><a href="usersignout.jsp"><span class="glyphicon glyphicon-log-in"style="padding-right: 4px";>
	  </span>SignOut</a></li>
...
<h3><b><strong>Login Success.</strong></b></h3><br>
<br>


<br><br><br><br><br>

<a href="userproduct.jsp">Click here to shop now.</a>
<br><br><br><br><br>
