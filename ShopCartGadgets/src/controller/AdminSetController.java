...
@WebServlet("/AdminSetController")
public class AdminSetController extends HttpServlet {
	
	private AdminAddUserDAO dao;
	private static final long serialVersionUID = 1L;
	public static final String lIST_USER = "/adminsetplist.jsp";
	public static final String INSERT_OR_EDIT = "/adminsetupassword.jsp";
       
    public AdminSetController() {
