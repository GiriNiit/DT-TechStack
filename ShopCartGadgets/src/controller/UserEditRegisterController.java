...
@WebServlet("/UserEditRegisterController")
public class UserEditRegisterController extends HttpServlet {
	
	private UserRegisterDAO dao;
	private static final long serialVersionUID = 1L;
	public static final String lIST_REGISTER = "/usereditlistRegister.jsp";
	public static final String INSERT_OR_EDIT = "/usereditregister.jsp";
       
    public UserEditRegisterController() {
