		...
		<tbody>
			<c:forEach items="${users}" var="user">
				<tr>
					...
					<td><a
						href="UserController.do?action=edit&userId=<c:out value="${user.userId }"/>">Update</a></td>
					<td><a
						href="UserController.do?action=delete&userId=<c:out value="${user.userId }"/>">Delete</a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
